        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <div class="btn btn-primary add_new_record">Add Sub Expenses</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content form-submit-event" id="from_submit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add Sub Expenses</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Select Expense<span
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Sub Expense Name<span
                                    class="asterisk">*</span></label>
                            <input type="text" required id="ESTitle" name="ESTitle" class="form-control"
...
@push('scripts')
    ...
    <script>
        ...
        $("body").on("click", ".edit_record", function(e) {
            ...
            $("#ExpenseID").val(details.ExpenseID);
            $("#ESTitle").val(details.ESTitle);
            $("#add_new_record_model").modal("show");
        });
        ...
        $("body").on("click", "#submit_btn", function(e) {
            ...
            $("#from_submit").ajaxSubmit({
                url: '{{ route('pos.save_sub_expanses') }}',
                type: 'post',
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $(document).ready(function() {
            ...
            user_table = $('#users-list').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: '{{ route('pos.sub_expenses_list') }}',
                    data: function(d) {
