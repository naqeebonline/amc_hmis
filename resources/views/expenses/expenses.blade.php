        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <div class="btn btn-primary add_new_record">Add New Expenses</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content form-submit-event" id="from_submit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add New Expenses</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Expense Name<span class="asterisk">*</span></label>
                            <input type="text" required id="ExpenseTitle" name="ExpenseTitle" class="form-control" placeholder="" autocomplete="off">
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        $("body").on("click",".edit_record",function (e) {
            ...
            $("#ExpenseTitle").val(details.ExpenseTitle);
            $("#add_new_record_model").modal("show");
        });
        ...
        $(document).ready(function (){
            ...
            user_table = $('#users-list').DataTable({
                ...
                columns: [
                    ...
                    {data: 'ExpenseTitle', name: 'ExpenseTitle',searchable: true},
