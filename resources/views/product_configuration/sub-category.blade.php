        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <div class="btn btn-primary add_new_record">Sub Category</div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Select Main Category<span
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Sub Category Name<span class="asterisk">*</span></label>
    ...
    <script>
        ...
        $("body").on("click","#submit_btn",function (e) {
            ...
            $("#from_submit").ajaxSubmit({
                url: '{{route('pos.save_sub_category')}}',
                type: 'post',
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $(document).ready(function (){
            ...
            user_table = $('#users-list').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: '{{route("pos.list_sub_category")}}',
                    data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'main_category.name', name: 'main_category.name',searchable: true},
