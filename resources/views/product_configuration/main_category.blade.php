        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <div class="btn btn-primary add_new_record">Add Main Category</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content form-submit-event" id="from_submit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add Main Category</h5>
    ...
    <script>
        ...
        $("body").on("click","#submit_btn",function (e) {
            ...
            $("#from_submit").ajaxSubmit({
                url: '{{route('pos.save_main_category')}}',
                type: 'post',
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $(document).ready(function (){
            ...
            user_table = $('#users-list').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: '{{route("pos.list_main_category")}}',
                    data: function (d) {
