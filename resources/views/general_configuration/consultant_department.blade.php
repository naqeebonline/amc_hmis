        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <div class="btn btn-primary add_new_record">Add Consultant Department</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content form-submit-event" id="from_submit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add Consultant Department</h5>
    ...
    <script>
        ...
        $("body").on("click","#submit_btn",function (e) {
            ...
            $("#from_submit").ajaxSubmit({
                url: '{{route('pos.save_consultant_department')}}',
                type: 'post',
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $(document).ready(function (){
            ...
            user_table = $('#users-list').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: '{{route("pos.list_consultant_department")}}',
                    data: function (d) {
