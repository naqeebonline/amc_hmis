        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <div class="btn btn-primary add_new_record">Add Ward Bed</div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Select Ward<span
        ...
        $(document).ready(function (){
            ...
            user_table = $('#users-list').DataTable({
                ...
                columns: [
                    ...
                    {data: 'ward.name', name: 'ward.name',searchable: true},
