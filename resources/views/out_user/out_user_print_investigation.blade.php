    ...
    <section class="items">
        ...
        <table style="margin-top: 5px">
            ...
            <tr>
                ...
                <th style="width: 10%;">Investigation Name</th>
            ...
            @foreach($data as $key => $value)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('pos.print_out_user_inv_result',[\Illuminate\Support\Facades\Crypt::encrypt($value->id)])}}" target="_blank">Print</a>
                    </td>
