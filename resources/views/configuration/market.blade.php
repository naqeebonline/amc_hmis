        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <div class="btn btn-primary add_new_record">Add New Market</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content form-submit-event" id="from_submit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add New Market</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Market Name<span class="asterisk">*</span></label>
