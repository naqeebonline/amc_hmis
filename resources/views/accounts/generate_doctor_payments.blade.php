                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3 mt-4">
                             <div class="btn btn-primary print_all_details">Generate Doctor Invoice</div>
                         </div>
                     </div>
                    @endif
            ...
            <form class="modal-content form-submit-event" id="cancel_admission_form">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label">Consultant Share (%age)<span
                                        class="asterisk">*</span></label>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control" name="procedure_rate" id="procedure_rate">
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        user_table = $('#patient-list').DataTable({
            ...
            pageLength: 10,
            ajax: {
                url: "{{ route('pos.load_discharge_patients_for_doctor_payments') }}",
                data: function (d) {
        ...
        $("body").on("change", "#edit_consultant_id", function(e) {
            ...
            $("#consultant_share").val(consultant_share);
        });

        $("body").on("change", "#edit_procedure_type_id", function(e) {
        ...
        $("body").on("click", ".edit_record", function(e) {
            ...
            $("#procedure_rate").val(details.procedure_rate);
