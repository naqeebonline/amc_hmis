    ...
    <header>
        ...
        <div class="invoice-meta header-right">
            <table style="width: 95%">
                ...
                <!--<tr>
                    <td style="width: 30% !important;">Customer:</td>
                ...
                <tr>
                    <td style="width: 30% !important;">Printed By</td>
            ...
            <table style="margin-top: 5px">
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%;">Consumed Qty</th>
        ...
        <section class="totals">
            ...
            <table style="width: 45% !important;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>£ <?php $gtotal = ($totalAmount) + ($taxAmount); echo number_format($gtotal,2); ?></td>
                    </tr>

                    <tr>
                        <td><strong>Received Amount:</strong></td>
                        <td>£ <?php $received_amount = $record[0]->received_amount; echo number_format($received_amount,2);?></td>
                    </tr>

                    <tr>
                        <td><strong>Total Dues:</strong></td>
                        <td>£ <?php $balance = $prev_balance; echo number_format($balance,2);?></td>
                    </tr>
