...
<head>
    ...
    <style>
        ...
        body {
            font-family: "Poppins", "Jameel Noori Nastaleeq Regular";
            margin: 0;
            padding: 0;
...
<body>
    ...
    <?php
    $result = $res['result'];
    $inv_sub_category = $res['inv_sub_category'];
    ...
    <div class="invoice-container">
        ...
        <main>
            ...
            <div class="inv-detail row">
                ...
                <div class="left-side col-5">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <p class="w-50">{{ ucfirst($result->patient->name) }}</p>
                    </div>

                    <div class="d-flex justify-content-between">
                        <p class="w-50 fw-bold">Age | Gender:</p>
                        <p class="w-50">{{ $result->patient->age }}-Year | {{ ucfirst($result->patient->gender) }}</p>
                    </div>
            ...
            <section class="items">
                <table class="table table-bordered invoice-table">
                    ...
                    <tbody>
                        ...
                        @endphp
                        <?php if (($default_heading != strtolower($item->parameter_heading) || $key == 0) && $default_heading != 'no heading') {
                            $default_heading = strtolower($item->parameter_heading); ?>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                {{ ucfirst($item->result_text_value) }}
                            </td>
                            @else
            ...
            <p class="footer-note"
                style="margin-top:5px; font-size:12px; font-style:italic; border-top:1px solid #ccc; padding-top:4px;">
        ...
        <footerser style="margin-top: 320px;">
