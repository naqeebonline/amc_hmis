        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <a class="btn btn-primary" href="{{route('pos.add_new_add_new_stock')}}">Add New Bill</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="table-responsive" style="min-height: 200px">
                                ...
                                <table id="users-list" style="width: 100% !important;" class="table table-responsive table-striped data_mf_table table-condensed table-responsive" >
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form class="modal-content form-submit-event" id="from_submit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add New Ward</h5>
    ...
    <script>
        ...
        $(document).ready(function (){
            ...
            user_table = $('#users-list').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: '{{route("pos.list_grn_request")}}',
                    data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'bill_c_status', name: 'bill_c_status',searchable: true},
            ...
            $("body").on("click",".approve_bill",function (e) {
                var id = $(this).attr("bill_id");
                if (confirm('Do you want to proceed?')) {
                    $.ajax({
                        type: 'post',
                        url: "{{ route('pos.approve_grn_bill') }}",
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}'
