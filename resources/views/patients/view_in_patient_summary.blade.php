                            ...
                            <div class="" id="patient_detail">
                                <table class="table table-responsive table-bordered">
                                    ...
                                    <tr style="background-color: lightgrey; font-weight: bold; color:green">
                                        <td>Procedure Amount: {{ $summary['procedure_amount'] }}</td>
                                        <td >Investigation : {{ $summary['investigation_amount'] }}</td>
                                        <td>Medicine: {{ $summary['medicine_amount'] }}</td>
                                        <td >Consultant shares: {{ $summary['consultant_share_amount'] }}</td>
                                        <td>Service Charges: {{  $summary['service_charges'] }}</td>
                                        <td>Balance: {{  $summary['balance'] }}</td>
    ...
    <script>
        ...
        function loadInvestigationData(patient_id, admission_id = '') {
            investigation_table = $('#investigation_table').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: `{{ route('pos.get_in_admission_investigations') }}/${patient_id}/${admission_id}`,
                    data: function(d) {
        ...
        $("body").on("click", ".print_medicine_report", function(e) {
            ...
            var url = "{{route('pos.in_patient_treatment_chart_report')}}"+"/"+patient_id+"/"+admission_id+"/"+medicine_type_id;
