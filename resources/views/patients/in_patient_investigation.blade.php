                            ...
                            <form action="" id="add_patient_investgiation">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select name="" id="admit_patient" required class="form-select">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="investigation_sub_category_id" required
                                            ...
                                            @forelse ($investigation as $item)
                                                <option data-rate="{{ $item->sale_price }}" value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @empty
                                            @endforelse
                                        </select>
...
@push('scripts')
    ...
    <script>
                ...
                success: function(res) {
                    ...
                    if (res.data.length > 0) {
                        ...
                        $.each(res.data, function(key, bed) {
                            $("#investigation_sub_category_id").append(
                                `<option value="${bed.id}" data-rate="${bed.sale_price}">${bed.name}</option>`
                            )
                        });
                    }
        ...
        $("#add_patient_investgiation").on("submit", function(e) {
            e.preventDefault();
            let isValid = true;
            var patient_id = $("#admit_patient").val();
