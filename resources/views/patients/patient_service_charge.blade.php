                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="nameBasic" class="form-label">Amount<span
                                                class="asterisk">*</span></label>
                                        <input type="number" required id="service_rate" name="service_rate"
                                            class="form-control" placeholder="" autocomplete="off">
                                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        $("#add_service_charges").on("submit", function(e) {
            e.preventDefault();
            ...
            if (isValid) {
                ...
                $("#add_service_charges").ajaxSubmit({
                    ...
                    success: function(response) {
                        ...
                        $("#save_inv_btn").prop('disabled', false).text("Save Service Charge");
