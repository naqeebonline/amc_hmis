                    ...
                    <form class=" form-submit-event" id="patient_admission">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" required id="procedure_rate" name="procedure_rate"
                                       oninput="if(this.value.length > 11) this.value = this.value.slice(0, 11);"
                                       class="form-control" placeholder="" autocomplete="off">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label for="nameBasic" class="form-label">Advance Payment</label>

                                <input type="number" required id="advance_payment" name="advance_payment"
                                       oninput="if(this.value.length > 11) this.value = this.value.slice(0, 11);"
                                       class="form-control" placeholder="" value="0" autocomplete="off">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label for="nameBasic" class="form-label">Security Received</label>

                                <input type="number" required id="security_amount" name="security_amount"
                                       oninput="if(this.value.length > 11) this.value = this.value.slice(0, 11);"
                                       class="form-control" placeholder="" value="0" autocomplete="off">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 mb-3">
                                ...
                                <select name="included_medicine" required id="included_medicine" class="form-select">
                                    <option value="">Select Relation</option>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="nameBasic" class="form-label">Procedure Rate<span
                                    class="asterisk">*</span></label>
                        <input type="number" class="form-control" id="edit_procedure_rate" name="edit_procedure_rate">
                    </div>
