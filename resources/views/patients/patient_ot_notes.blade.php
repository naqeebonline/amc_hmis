                            ...
                            <form action="" id="add_ot_notes">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="ot_notes" id="ot_notes" class="form-control" cols="30" rows="6"></textarea>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        $("#add_ot_notes").on("submit", function(e) {
            e.preventDefault();
            ...
            if (isValid) {
                ...
                $("#add_ot_notes").ajaxSubmit({
                    url: '{{ route('pos.save_patient_ot_notes') }}',
                    type: 'post',
                    data: {
                        _token: '{{ csrf_token() }}',
                    },
