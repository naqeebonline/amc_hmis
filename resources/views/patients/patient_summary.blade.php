...
@push('scripts')
    ...
    <script>
        ...
        $("body").on("change", "#admit_patient", function(e) {
            $('#patient_vital_notes_table').DataTable().destroy();
            $('#patient_nusing_notes_table').DataTable().destroy();
            ...
            let html = `
                <table class="table table-responsive table-bordered" >
                    ...
                    <tr>
                        ...
                        <td style="color:red;font-weight:bold">${data.consultant.name ?? ""}</td>
                        <td style="font-weight: bold">Procedure</td>
                        <td style="color:red;font-weight:bold">${data.procedure_type.name ?? ""}</td>
