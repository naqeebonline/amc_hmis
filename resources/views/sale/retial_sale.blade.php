...
<body>
                    ...
                    <div class="col-md-6 mt-1">
                        ...
                        <select class="form-control" id="product_id">
                            ...
                            <?php foreach ($products as $key => $value): ?>
                                ...
                                <option value="{{$value->ProductID}}" data-purchasePrice={{$value->unit_sale_price}} data-taxPercentage="{{$value->taxPercentage}}" data-allowPercentage="{{$value->allow_percentage ?? 0}}">{{$value->ProductName}} | {{$value->generic_name?->name ?? ''}} | PS: {{$value->pack_size}} | Qty {{$value->avaliable_qty}}</option>
                                @endif
                            <?php endforeach; ?>
                        </select>
    ...
    <script type="text/javascript">
        ...
        function reload_table() {
            ...
            $("#ReceivedAmount").val(Math.ceil(total_amount - total_product_discount_amount - invoice_discount));
