                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="doctor" class="form-label"> Customer</label>
                                        <select class="form-select" required id="SID" name="SID">
                                            <option value="">Select Supplier</option>
                                            @foreach ($suppliers as $key => $value)
                                                <option value="{{ $value->SCID }}">{{ $value->Name }} :
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="payment_type_id" id="payment_type_id" class="form-select">
                                            ...
                                            @foreach ($payment_type as $key => $value)
                                                <option value="{{ $value->payment_type_id }}">{{ $value->payment_type }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                    <li class="nav-item">
                                        <button class="nav-link active" data-bs-toggle="tab"
                                            data-bs-target="#all-payment-tab" role="tab" aria-selected="false">
                                            Receivables
                                        </button>
                                    </li>

                                    <li class="nav-item">
                                        <button class="nav-link " data-bs-toggle="tab" data-bs-target="#all-bills-tab"
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active show" id="all-payment-tab" role="tabpanel">
                                    <div class="table-responsive" style="min-height: 200px">
                                        ...
                                        <table id="payment_list" style="width: 100% !important"
                                ...
                                <div class="tab-pane fade " id="all-bills-tab" role="tabpanel">
                                    <div class="table-responsive" style="min-height: 200px">
                                        ...
                                        <table id="doctor-orders" style="width: 100% !important;"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("body").on("click", ".print_invoice", function() {
                ...
                var date = "{{date("Y-m-d")}}";
                url="{{route('pos.print_purchase_detail')}}/"+sale_id+"/"+date;
                window.open(url, 'Print Bill', 'width=1200,height=600,scrollbars=yes');
            });
            ...
            $("body").on("click", "#submit_btn", function(e) {
                ...
                $("#from_submit").ajaxSubmit({
                    ...
                    url: '{{ route('pos.save_customer_payments') }}',
                    type: 'post',
                    data: {
                        _token: '{{ csrf_token() }}'
        ...
        function loadPaymentData(id) {
            payment_list = $('#payment_list').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: `{{ route('pos.receiveables', ':id') }}`.replace(':id', id),
                    data: function(d) {
        ...
        function loadDoctorOrders(id) {
            doctor_orders_table = $('#doctor-orders').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: `{{ route('pos.sale_details', ':id') }}`.replace(':id', id),
